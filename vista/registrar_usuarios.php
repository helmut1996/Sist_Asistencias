...
<div class="page-content">
    ...
    <h4 class= "text-center text-secundary">REGISTRO DE USUARIOS</h4>
    ...
    <div class="row">
        <form action="" method = "POST">
            ...
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
                <input type="text" class="input input__text" placeholder="Usuarios" name="txtusuario">
            </div>
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
                <input type="password" class="input input__text" placeholder="Contraseña" name="txtpassword">
            </div>
